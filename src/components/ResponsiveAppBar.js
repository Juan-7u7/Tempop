...
const settings = ['Registrarse', 'Iniciar Sesión'];
...
function ResponsiveAppBar() {
  ...
  const handleCloseNavMenu = (page) => {
    ...
    // Maneja la navegación al hacer clic en "Inicio"
    if (page === 'Inicio') {
  ...
  const handleCloseUserMenu = (setting) => {
    ...
    if (setting === 'Registrarse') {
      navigate('/register'); // Redirige a la página de registro
    }
    if (setting === 'Iniciar Sesión') {
      navigate('/login'); // Reemplaza con la ruta correcta si tienes una página de inicio de sesión
    }
  };
